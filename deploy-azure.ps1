...
} else {    # If not found, create a simple Dockerfile for the static site
    Write-Host "No Dockerfile found, creating one for static website deployment..." -ForegroundColor Yellow
    @"
FROM nginx:alpine
